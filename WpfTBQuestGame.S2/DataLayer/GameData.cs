...
namespace WpfTBQuestGame.S2.DataLayer
{
    public static class GameData
    {
        ...
        public static List<string> InitialMessages()
        {
            ...
            {
                "You have been hired by the Space Mission Corporation to participate in its latest Space explore programme, " +
                "the Space Mission Project. Your mission is to explore other planets for collect tresaure and report back to " +
                "the Space Mission Corporation. The Space Mission Corportion is an independent company responsible for " +
                "the civilian space program, as well as aeronautics and aerospace research. The Sapce Mission was established in 1958." +
                "The new agency was to have a distinctly civilian orientation, encouraging peaceful applications in space science." +
                "Since its establishment, most private US space exploration efforts have been led by Space Mission Corportion."
            };
        }
        ...
        public static Map GameMapData()
        {
            ...
            gameMap.MapLocations[0, 0] = new Location()
            {
                Id = 1,
                Name = "Mars",
                Description = "Island Mars is the fourth planet from the Sun and the second-smallest planet " +
                "in the Solar System after Mercury. In English, Mars carries a name of the Roman god of war, " +
                "and is often referred to as the Red Planet because the reddish iron oxide prevalent on " +
                "its surface gives it a reddish appearance that is distinctive among the astronomical bodies " +
                "visible to the naked eye. Mars is a terrestrial planet with a thin atmosphere, having surface" +
